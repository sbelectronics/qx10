...
CONST4      .EQU    (2*FRAG)+uncomp
CONST5      .EQU    (FRAG)+uncomp
CONST6      .EQU    (3*FRAG)-1
;
;
;
...
psglp:	ld	c,e		; C := RSEL
	...
	outi			; Set register value
        inc     a		; Next register
        ld      bc, CONST6  ; Bytes to skip before next reg-1
        add     hl,bc		; Update HL
...
; zasm doesn't like ORGs that overlap
uncomp   .EQU HEAP
rows     .EQU (uncomp + 3*FRAG*REGS)
data     .EQU (rows+2)
